<template>
  <div class="slide-verify" id="slideVerify" onselectstart="return false;">
    ...
    <div class="slide-verify-slider"
         :class="{'container-active': containerActive, 'container-success': containerSuccess,
...
export default {
  ...
  data() {
    return {
      ...
      containerSuccess: false, // 容器成功类
      containerFail: false, // 容器失败类
      canvasCtx: null,
      blockCtx: null,
      block: null,
      block_x: undefined, // 容器随机位置
      block_y: undefined,
  ...
  methods: {
    ...
    createImg(onload) {
      ...
      axios.get("/get").then(res => {
        ...
        img.onerror = () => {
          // img.src = res.data.data.background.url
