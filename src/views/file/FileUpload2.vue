    ...
    <el-form :model="form" label-width="120px">
      ...
      <el-form-item>
        <el-upload class="upload-demo" :action="uploadUrl"
                   ...
                   :before-remove="beforeRemove" multiple :limit="5"
...
export default {
  ...
  methods: {
    //测试下载文件(注意web的上下文)
    handleDownLoad() {
      window.location.href = `http://localhost:8081/file/download?fileName=` + this.form.fileName
    },
    ...
    handleBeforeUpload(file) {
      this.uploadUrl = `http://localhost:8081/file/upload`
    }
    //,
    // handleSubmit() {
    //   var params = {}
